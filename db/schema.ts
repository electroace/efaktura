...
export const companies = sqliteTable("companies", {
  ...
  invoiceTitle: text("invoice_title").notNull().default("Faktura"),
  offerTitle: text("offer_title").notNull().default("Ponuda"),
  showDiscount: integer("show_discount", { mode: "boolean" }).notNull().default(false),
