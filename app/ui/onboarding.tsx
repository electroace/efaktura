  ...
  return <section className="setup-layout">
    ...
    <div className="panel company-form"><form onSubmit={submit}>
      ...
      <div className="settings-document"><h2>Izgled novih dokumenata</h2>
        ...
        <label>Zadana napomena <textarea className="notes-input" rows={3} maxLength={1600} value={form.defaultNote} onChange={e=>set("defaultNote",e.target.value)} placeholder="Npr. uslovi isporuke ili plaćanja"/><small>Predlaže se u svakom novom dokumentu; možete je promijeniti za svaki dokument.</small></label>
