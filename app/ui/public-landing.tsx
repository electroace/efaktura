...
export function PublicLanding() {
  return <main className="marketing-page">
      ...
      <div className="marketing-product" aria-label="Primjer pregleda aplikacije">
        <div className="product-window"><div className="product-window-top"><div className="product-window-dots"><i/><i/><i/></div><span>Radni prostor · eFaktura</span><span className="product-window-avatar">e</span></div>
          <div className="product-window-body"><div className="product-demo-heading"><div><small>PREGLED POSLOVANJA</small><h2>Vaši dokumenti</h2><p>Sve na jednom mjestu, spremno za slanje.</p></div><span><Plus size={15}/> Novi dokument</span></div>
            <div className="product-demo-stats"><div><small>Fakture ovog mjeseca</small><strong>2 <i>/ 3</i></strong><span>Besplatni paket</span></div><div><small>Dokumenti</small><strong>08</strong><span>Fakture i ponude</span></div><div><small>Vaš logo</small><strong><FileCheck2 size={26}/></strong><span>Na svakom dokumentu</span></div></div>
    ...
    <section id="paketi" className="marketing-pricing"><div className="marketing-section-title"><span className="marketing-kicker">JEDNOSTAVNE CIJENE</span><h2>Počnite besplatno.<br/>Rastite bez ograničenja.</h2><p>Pakete možete birati kada vama odgovara.</p></div><div className="marketing-plan-grid">
      <article className="marketing-plan"><div className="marketing-plan-head"><span>Za početak</span><h3>Besplatno</h3><p>Za povremeno fakturisanje i svakodnevne ponude.</p></div><div className="marketing-price">0 KM <small>/ mjesečno</small></div><a href={signup} className="marketing-plan-link">Registruj se besplatno <ArrowRight size={17}/></a><ul><li><Check size={17}/> Do 3 fakture mjesečno</li><li><Check size={17}/> Do 5 stavki po fakturi</li><li><Check size={17}/> Ponude i drugi dokumenti bez mjesečnog limita</li><li><Check size={17}/> Logo firme, PDF i Word</li></ul></article>
      <article className="marketing-plan marketing-plan-paid"><div className="marketing-plan-badge"><InfinityIcon size={16}/> Više prostora za posao</div><div className="marketing-plan-head"><span>Za redovan rad</span><h3>Neograničeno</h3><p>Fakture bez mjesečnog limita i više stavki na dokumentu.</p></div><div className="marketing-price">22 KM <small>/ mjesečno, s PDV-om</small></div><a href={signup} className="marketing-plan-link">Odaberi plaćeni paket <ArrowRight size={17}/></a><ul><li><Check size={17}/> Neograničen broj faktura mjesečno</li><li><Check size={17}/> Do 100 stavki po dokumentu</li><li><Check size={17}/> Ponude i drugi dokumenti</li><li><Check size={17}/> Predračun odmah nakon zahtjeva</li></ul><p className="marketing-plan-note">Plaćeni pristup se uključuje nakon evidentirane uplate. Administrator može odrediti posebnu cijenu za vašu firmu.</p></article>
    </div></section>
