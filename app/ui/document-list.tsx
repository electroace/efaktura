...
export function DocumentList({ documents }: {documents: Entry[]}) {
  return <section className="panel list-panel">
    ...
    {!documents.length ? <div className="empty-list"><div className="empty-icon"><FileText size={28}/></div><h3>Još nemate dokumenata</h3><p>Kreirajte prvu fakturu, ponudu ili dokument po svom nazivu.</p><Link href="/novi" className="secondary-button">Kreiraj prvi dokument</Link></div>
