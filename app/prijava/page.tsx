...
export default async function SignInPage({ searchParams }: { searchParams: Promise<{ next?: string }> }) {
  ...
  if (!supabaseConfigured()) return <main className="auth-shell"><div className="panel auth-panel"><h1>Prijava</h1><p>Prijava za javnu aplikaciju još nije povezana.</p><a className="primary-button" href={signInPath(next)} target="_top">Prijava za pregled</a></div></main>;
